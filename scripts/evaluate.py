"""
Write and read data in deformnet_eval/nocs_results/val/results_val_*_*.pkl
Copy from https://github.com/mentian/object-deformnet/blob/master/evaluate.py
"""
import os
import time
import argparse
...
from scene_grasp.scene_grasp_net.utils.nocs_eval_utils_od import load_depth, get_bbox, compute_mAP, plot_mAP
...
if opt.data == 'val':
    ...
    result_dir = 'data/deformnet_eval/nocs_results/val'
    file_path = 'CAMERA/val_list.txt'
    cam_fx, cam_fy, cam_cx, cam_cy = 577.5, 577.5, 319.5, 239.5
else:
    # result_dir = 'results/eval_real'
    result_dir = 'data/deformnet_eval/nocs_results/real_test'
...
def evaluate():
    ...
    iou_aps, pose_aps, iou_acc, pose_acc = compute_mAP(pred_results[:20], result_dir, degree_thres_list, shift_thres_list,
