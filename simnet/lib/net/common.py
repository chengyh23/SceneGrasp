...
from common.config.config_dataset_details import get_emb_dim, get_n_points
...
def add_train_args(parser):
  ...
  parser.add_argument("--model_seg_num_classes", type=int, default=7)
  ...
  # Scale ae args:
  parser.add_argument("--scale_ae_path", default=None, type=str)
  parser.add_argument("--scale_ae_emb_dim", default=get_emb_dim(), type=int)
  parser.add_argument("--scale_ae_num_point", default=get_n_points(), type=int)
  parser.add_argument("--choose_bd_sign", default=True, type=bool)
...
def simnet_collate(batch):
  ...
  return stacked_images, targets[1], targets[2], targets[3], targets[4], targets[5], targets[6], targets[7], targets[8], targets[9]
