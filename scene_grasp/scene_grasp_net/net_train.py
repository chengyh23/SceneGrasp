...
from common.config.config_global_paths import PROJECT_LOGS_ROOT
...
if __name__ == "__main__":
  ...
  logs_root = PROJECT_LOGS_ROOT / "scene_grasp_net"
  logs_suffix = "finetune_real" if hparams.finetune_real else None
  logs_dir, _ = init_logs_dir(
    logs_root,
    "scene_grasp_net_training",
    logs_suffix,
    input_args=vars(hparams)
  )
